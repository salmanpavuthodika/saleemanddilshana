...
export default function EnvelopeEntrance({ onOpen, onOpenStart }: EnvelopeEntranceProps) {
  ...
  const paperTextureStyle = {
    backgroundColor: "#F7F2E8", // Light beige fallback
      ...
      {!isRevealed && (
        ...
        >
          ...
          >
            {/* Textured top flap */}
            <div 
              className="absolute inset-0 border-b-2 border-[#C6B6B9] shadow-[0_12px_40px_rgba(40,25,28,0.15)] overflow-hidden"
          ...
          >
            ...
            <div 
              className="absolute inset-0 border-t-2 border-[#EAE0E2] shadow-[-0_-12px_40px_rgba(40,25,28,0.1)] overflow-hidden"
              style={paperTextureStyle}
            >
              {/* Vignette styling for authentic paper depth */}
